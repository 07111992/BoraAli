    ...
    return <div>
        ...
        <main className="containercards">
            ...
            <div className="card">
                ...
                <h1>Marco Zero</h1>
                <p>Importante e presentativo ponto turístico da cidade, localizado às margens do Rio Capibaribe. Este marco é reconhecido como o centro geográfico da cidade e possui uma admirável rosa dos ventos no chão.
                </p>
            ...
            <div className="card">
                ...
                <h1>Porto Digital</h1>
                <p>Parque tecnológico, que se destaca como um dos principais polos de inovação e tecnologia no país. Fundado em 2000, oferece um ambiente propício para empresas de TI, startups e instituições de pesquisa.
                </p>
                <Link to= "PasseiosDetalhes" ><button className="btn">Saiba Mais!</button></Link>
            </div>
            ...
            <div className="card">
                ...
                <p>Espaço dedicado à preservação e exibição das obras do renomado artista brasileiro Francisco Brennand. O museu está situado na antiga fábrica de cerâmica da família Brennand e abriga uma vasta coleção de esculturas, azulejos, pinturas e outras peças criadas pelo artista.
                </p>
                <Link to= "PasseiosDetalhes" ><button className="btnb">SAIBA MAIS!</button></Link>
            </div>
            ...
            <div className="card">
                ...
                <p>Um dos mais antigos do Brasil, com mais de 300 anos de história. É estratégico para a economia regional, sendo um importante centro de movimentação de cargas e passageiros. Sua localização privilegiada o torna um ponto chave para o comércio marítimo.
                </p>
                <Link to= "PasseiosDetalhes" ><button className="btnb">SAIBA MAIS!</button></Link>
            </div>
            ...
            <div className="card">
                ...
                <p>Destino conhecido por suas praias, suas piscinas naturais e seus passeios de buggy, é um destino popular para turistas em busca de belezas naturais. Para além do mar. O lugar oferece passeios variados, lojinhas ótimas para comprar artesanato,
                </p>
                <Link to= "PasseiosDetalhes" ><button className="btnb">SAIBA MAIS!</button></Link>
            </div>
            ...
            <div className="card">
                ...
                <p>Espaço multifuncional que promove eventos culturais, exposições, workshops e atividades artísticas para a comunidade. Localizada no coração da cidade, oferece acesso a diversas manifestações culturais, como dança, música, teatro e artes visuais.
                </p>
                <Link to= "PasseiosDetalhes"><button className="btnb">SAIBA MAIS!</button></Link>
            </div>
