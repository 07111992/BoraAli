...
import img3BomJesusPage3 from "../../img/pagina passeiosdetalhes2 rua-do-bom-jesus-antiga.png"
export default function PasseiosDetalhes2() {
    return <div>

        <main className="bomJesus">
            <div className="containerBomJesus">

                <img src={imgBomJesusPage}></img>
                <h1>Rua do Bom Jesus</h1>
            </div >

            <div className="containerTextoBomJesus">
                <h1 className="title1_bj">Rua do Bom Jesus</h1>
    ...
    <img className="ruaBomJesus2" src={img2BomJesusPage2}></img>



<h1 className="title2_bj">Rua do Bom Jesus História:
</h1>
...
<div className="ruaBomJesus3"><img src={img3BomJesusPage3}></img></div>
...
<h1 className="title3_bj">Rua do Bom Jesus Restaurantes</h1>
...
<h1 className="title4_bj">Horário de funcionamento Rua do Bom Jesus
</h1>
